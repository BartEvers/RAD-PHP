            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col l12 col m12 col s12">
                        ...
                        <!-- Footer Column 4 -->
                        <ul>
                            <li class="footer-title">Money</li>
                            <li>
                        ...
                        <!-- Footer Column 6 -->
                        <ul>
                            <li class="footer-title">Travel</li>
                            <li>
                        ...
                        <!-- Footer Column 7 -->
                        <ul>
                            <li class="footer-title">Option</li>
                            <li>
                        ...
                        <!-- Footer Column 8 -->
                        <ul>
                            <li class="footer-title">Weather</li>
                            <li>
                ...
                <!-- Footer Logo -->
                <div class="logo">
                    <a href="index.html"><img src="themes/Template-Material-News/images/material-logo.png" alt="Logo"></a>
                </div>
            </div>
            <!-- Footer Bottom -->
    ...
    <!-- Jquery -->
    <script src="themes/Template-Material-News/js/jquery-min.js"></script>
    <!-- Materialize JS -->
    <script src="themes/Template-Material-News/js/materialize.js"></script>
    <!-- Plugin JS -->
    <script src="themes/Template-Material-News/js/pgwslider.js"></script>
    <script src="themes/Template-Material-News/js/jquery.touchSwipe.min.js"></script>
    <script src="themes/Template-Material-News/js/jquery.liquid-slider.js"></script>
    <script type='text/javascript' src='themes/Template-Material-News/js/camera.js'></script>
    <!-- Custom Js -->
    <script src="themes/Template-Material-News/js/init.js"></script>
  </body>
</html>